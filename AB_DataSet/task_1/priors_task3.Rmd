...
subsets <- read_excel("/Users/allisonselwah/Downloads/MAT4376/project2/subsets_set1.xlsx") # first 12 subsets of 100 datapoints 

df <- data.frame(ab_data)

df <- subset(df, select = c("index", "landing_page", "converted"))

df <- df[!(row.names(subsets) %in% c("index")),]
...
write_xlsx(sheets,"/Users/allisonselwah/Downloads/MAT4376/project2/subsets1.xlsx")
```
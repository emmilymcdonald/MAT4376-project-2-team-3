...
df <- subset(df, group != 'control', select = c("index", "landing_page", "converted"))
...
write_xlsx(sheets,"/Users/allisonselwah/Downloads/MAT4376/project2/subsets_treatment.xlsx")
```